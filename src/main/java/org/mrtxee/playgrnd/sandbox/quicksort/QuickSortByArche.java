...
public class QuickSortByArche extends AbstractQuickSort {
  ...
  /**
   * Бежим по массиву, сдвигаем стену только тогда, когда текущее значение массива <= оси
   * При этом меняем значения стены и текущего элемента местами, чтобы если будет элемент со значением выше оси, то
   * он сдвигался бы вправо.
