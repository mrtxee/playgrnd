  ...
  public void delete(T value) {
    ...
    if (nodeToDelete.getLeft() == null ^ nodeToDelete.getRight() == null) {
      ...
      if (nodeToDelete.getLeft() != null) {
        substituteNode = nodeToDelete.getLeft();
      }
      if (nodeToDelete.getRight() != null) {
        substituteNode = nodeToDelete.getRight();
      }
      if (parentNodeToDelete != null
          && parentNodeToDelete.getValue().compareTo(substituteNode.getValue()) < 0) {
    ...
    if (nodeToDelete.getLeft() != null && nodeToDelete.getRight() != null) {
      ...
      if (null != parentNodeToDelete) {
        if (isLeftNodeToDelete) {
          parentNodeToDelete.setLeft(substituteNode);
        } else {
          parentNodeToDelete.setRight(substituteNode);
        }
      } else {
