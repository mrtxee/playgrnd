...
public class AxnProcessor extends AbstractProcessor {
  ...
  private void generateWrapperClass(TypeElement classElement, ExecutableElement method)
    ...
    JavaFileObject file =
        processingEnv.getFiler().createSourceFile(packageName + "." + wrapperClassName);
    ...
    try (Writer writer = file.openWriter()) {
      ...
      writer.write("        System.out.println(\"[Axn] Before method " + methodName + "\");\n");
      writer.write("        try {\n");
      writer.write("            " + className + "." + methodName + "();\n");
      writer.write("            System.out.println(\"[Axn] After method " + methodName + "\");\n");
      writer.write("        } catch (Exception e) {\n");
      writer.write("            System.out.println(\"[Axn] Error in method " + methodName
          + ": \" + e.getMessage());\n");
      writer.write("        }\n");
      writer.write("    }\n");
      writer.write("}\n");
